...
Documentation   Tests Cases das PBIs de CADASTRO e EDIÇÃO (Dados e Endereço) de empresas
...
[CT1] - Cadastrar Empresa com dados válidos (caminho feliz)
...
# [CT43] - Cadastrar empresa com o campo "Complemento" vazio (campo não obrigatório)
#     ${razaoSocial}=     Gerar Razao Social
#     ${nomeFantasia}=              Gerar Nome Fantasia
#     ${email}=            Gerar E-mail Randômico (@company.com)
#     ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
# [CT1] - Editar Empresa com dados válidos (caminho feliz)
#     ${razaoSocial}=      Gerar Razao Social
#     ${nomeFantasia}=     Gerar Nome Fantasia
#     ${email}=            Gerar E-mail Randômico (@company.com)
#     ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
# [CT1] - Editar empresa com todos os dados de endereço válidos (camiinho feliz)
#     ${razaoSocial}=      Gerar Razao Social
#     ${nomeFantasia}=     Gerar Nome Fantasia
#     ${email}=            Gerar E-mail Randômico (@company.com)
#     ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
# [CT22] - Editar empresa com o campo "Complemento" vazio (campo não obrigatório)
#     ${razaoSocial}=      Gerar Razao Social
#     ${nomeFantasia}=     Gerar Nome Fantasia
#     ${email}=            Gerar E-mail Randômico (@company.com)
#     ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
# # Tests Cases - Lista de Cadastro de Empresa


# [CT1] - Campo "Pesquisar": por dado inválido (EX: CPF.)
#     ${razaoSocial}=      Gerar Razao Social
#     ${nomeFantasia}=     Gerar Nome Fantasia
#     ${email}=            Gerar E-mail Randômico (@company.com)
#     ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
# [CT2] - Campo "Pesquisar": por dado válido (EX: Nome da Empresa, CNPJ, E-mail...)
#     ${razaoSocial}=      Gerar Razao Social
#     ${nomeFantasia}=     Gerar Nome Fantasia
#     ${email}=            Gerar E-mail Randômico (@company.com)
#     ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
