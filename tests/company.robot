...
[CT01] - Cadastrar empresa com o campo "Complemento" com 81 caracteres válidos (alfanuméricos)
...
[CT43] - Cadastrar empresa com o campo "Complemento" com caracteres inválidos (especiais)
    ${razaoSocial}=     Gerar Razao Social
    ${nomeFantasia}=              Gerar Nome Fantasia
    ${email}=            Gerar E-mail Randômico (@company.com)
    ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
[CT1] - Editar empresa com o campo "Nome do Responsável" com apenas uma palavra.
    ${razaoSocial}=      Gerar Razao Social
    ${nomeFantasia}=     Gerar Nome Fantasia
    ${email}=            Gerar E-mail Randômico (@company.com)
    ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
[CT1] - Editar empresa com o campo "Complemento" com 81 caracteres válidos (alfanuméricos)
    ${razaoSocial}=      Gerar Razao Social
    ${nomeFantasia}=     Gerar Nome Fantasia
    ${email}=            Gerar E-mail Randômico (@company.com)
    ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
[CT22] - Editar empresa com o campo "Complemento" com caracteres inválidos (especiais)
    ${razaoSocial}=      Gerar Razao Social
    ${nomeFantasia}=     Gerar Nome Fantasia
    ${email}=            Gerar E-mail Randômico (@company.com)
    ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
[CT1] - Validar exibição das colunas no datagrid [Nome, E-mail, Telefone e CNPJ] da empresa.
    ${razaoSocial}=      Gerar Razao Social
    ${nomeFantasia}=     Gerar Nome Fantasia
    ${email}=            Gerar E-mail Randômico (@company.com)
    ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
[CT2] - Validar exibição do botão "Novo Cadastro" de regitro de empresa
    ${razaoSocial}=      Gerar Razao Social
    ${nomeFantasia}=     Gerar Nome Fantasia
    ${email}=            Gerar E-mail Randômico (@company.com)
    ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
...
[CT3] - Validar exibição do botão "Editar" registro de empresa
    ${razaoSocial}=      Gerar Razao Social
    ${nomeFantasia}=     Gerar Nome Fantasia
    ${email}=            Gerar E-mail Randômico (@company.com)
    ${numeroCNPJ}=       Gerar Numero de CNPJ randômico   
